 ...
 *
 */
public class driveStraightR extends Command {

	//private double dist=595;
	//double distanceL;
	//double distanceR;
    public driveStraightR(double distin) {
    ...
    /*	if (Robot.drive_subsystem.encoderInfoLeft()>=distanceL-20 || Robot.drive_subsystem.encoderInfoRight()>=distanceR-20){
    		Robot.drive_subsystem.arcadeDrive(0.5, Robot.drive_subsystem.getGyroAngle()*-0.1);
    	} else {
    	...
    	Robot.drive_subsystem.jkgnjankDrive(-0.45, -0.5);
    }
